...
CURATED_DATA['image'] = CURATED_DATA.apply(lambda row: row.name, axis=1)
...
CURATED_DATA.query('dataset_type == "train"').to_csv('x_subjects/train.csv')
CURATED_DATA.query('dataset_type == "validation"').to_csv('x_subjects/val.csv')
CURATED_DATA.query('dataset_type == "test"').to_csv('x_subjects/test.csv')
...
CURATED_DATA.query('dataset_type == "train"').to_csv('x_iris/train.csv')
CURATED_DATA.query('dataset_type == "validation"').to_csv('x_iris/val.csv')
CURATED_DATA.query('dataset_type == "test"').to_csv('x_iris/test.csv')
